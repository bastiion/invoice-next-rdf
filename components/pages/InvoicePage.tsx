...
import {Box, ListDivider, Sheet, Typography, Button, Checkbox, Table, Chip} from '@mui/joy';
    ...
    <>
      ...
      >
        ...
        <Box sx={{p: 2}}>
          ...
          <Box sx={{display: 'flex', flexDirection: 'column', gap: 2}}>
            {hasChanged && (
              <Button onClick={handleSave} color="success" variant="soft" fullWidth>
                <Save sx={{mr: 1}} />
                {t('actions.saveChanges')}
              </Button>
            )}

            <Button onClick={handleRemoveClick} color="danger" variant="outlined" fullWidth>
              <Delete sx={{mr: 1}} />
